...
| :--------------------------------------------------- | :---- |
| 🟢 Implemented                                       | 52    |
| 🟡 Partly Implemented or print info for manual check | 10    |
| 🔴 Not Implemented                                   | 57    |
| Total                                                | 119   |
...
| 2.13   | Ensure centralized and remote logging is configured (Automated)                                               | 🟢  |     |     |
...
| 2.18   | Ensure that experimental features are not implemented in production (Automated)                               | 🟢  |     |     |
...
| 3.22   | Ensure that the /etc/default/docker file permissions are set to 644 or more restrictively (Automated)         | 🟢  |     |     |
...
| 5.17   | Ensure that host devices are not directly exposed to containers (Manual)                                      |     |     | 🔴  |
